...
# We manually run assemble & dokka before publishToMavenCentral. If we only
# run publishToMavenCentral,
...
./gradlew assembleRelease dokkaGeneratePublicationHtml publishToMavenCentral --no-configuration-cache -PRELEASE_SIGNING_ENABLED=true
